...
<div class="box box-primary margin-10px">
    <div class="box-header with-border">
        ...
        <div class="row">
    <div class="col-md-6"></div><div class="col-md-6"><span class="pull-right"> <div class="form-group">
            <a type="submit" class="btn btn-primary" href="{{route('savetoexcel')}}">Export Report to Excel</a>
        </span>
  </div>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::open(['route' => 'record.search','method'=>'POST']) !!}
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            @foreach($reports as $report)
                <tr>
                    ...
                    <td>Table No. {{$report->table->table_no}}</td>
